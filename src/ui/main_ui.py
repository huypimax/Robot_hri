...
"}")
        ...
        self.btn_qna = QtWidgets.QPushButton(parent=self.widget_3)
...
"")
        ...
        self.horizontalLayout_4.addWidget(self.btn_qna)
        self.btn_navi = QtWidgets.QPushButton(parent=self.widget_3)
...
"")
        ...
        self.horizontalLayout_4.addWidget(self.btn_navi)
...
"}")
        ...
        self.horizontalLayout_7.setSpacing(60)
...
"")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QPixmap(":/icon/icon/speaker.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btn_speaker.setIcon(icon2)
...
"")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QPixmap(":/icon/icon/microphone.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.btn_micro.setIcon(icon3)
        ...
        spacerItem8 = QtWidgets.QSpacerItem(20, 14, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
...
"")
        ...
        self.prompt_qna_2 = QtWidgets.QLabel(parent=self.widget_12)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.prompt_qna_2.sizePolicy().hasHeightForWidth())
        self.prompt_qna_2.setSizePolicy(sizePolicy)
        self.prompt_qna_2.setMinimumSize(QtCore.QSize(0, 0))
        self.prompt_qna_2.setMaximumSize(QtCore.QSize(16777215, 300))
        font = QtGui.QFont()
        font.setFamily("Roboto")
        font.setPointSize(30)
        font.setBold(True)
        font.setWeight(75)
        self.prompt_qna_2.setFont(font)
        self.prompt_qna_2.setObjectName("prompt_qna_2")
        self.horizontalLayout_9.addWidget(self.prompt_qna_2)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.prompt_qna_2.setText(_translate("MainWindow", "Please press the microphone and speak your question. - Okay, heading to [Location]. Please follow me."))
